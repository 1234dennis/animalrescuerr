...
public class Owner extends Human {
    ...
    public void feed(Owner owner, Animal animal, PetFood petFood) {
        ...
        System.out.println(animal.getName() + " hunger level is :" + hungerLevel);

        if (animal.getFavfood().equals(petFood.getName())) {
            double happyLevel = animal.getHappy() + 1;
            System.out.println("and happy status i :" + happyLevel);
        }
    }
    ...
    public void play(Owner owner, Animal animal, Activity activity){
        ...
        double happyLevel = animal.getHappy() + 1;
        System.out.println(animal.getName() + " happiness :" + happyLevel);

        if(animal.getFavactivity().equals(activity.getName())){
            double happyLevel2 = animal.getHappy() + 1;
            System.out.println("That's " + animal.getName() + "  favourite activity, happiness :" + happyLevel2);
        }
    }
